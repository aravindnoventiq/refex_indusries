...
router.get("/about-page-section", ctrl.getAboutPageSection);
router.put("/about-page-section", ctrl.saveAboutPageSection);
...
router.put("/presence", ctrl.savePresence);

// Journey routes - order matters, more specific routes first
router.get("/journey", ctrl.getAboutJourney);
...
// Journey Items (for timeline items, different from AboutJourney)
router.get("/journey-items", ctrl.journey.list);
router.post("/journey-items", auth.authCheck, ctrl.journey.create);
// router.put("/journey-items/:id", auth.authCheck, ctrl.journey.update);
router.delete("/journey-items/:id", auth.authCheck, ctrl.journey.remove);

// Sticky Nav Items
router.get("/sticky-nav-items", ctrl.stickyNavItems.list);
router.post("/sticky-nav-items", ctrl.stickyNavItems.create);
router.put("/sticky-nav-items/:id", ctrl.stickyNavItems.update);
router.delete("/sticky-nav-items/:id", ctrl.stickyNavItems.remove);

// Committees
router.get("/committees", ctrl.committees.list);
router.post("/committees", auth.authCheck, ctrl.committees.create);
router.put("/committees/:id", auth.authCheck, ctrl.committees.update);
router.delete("/committees/:id", auth.authCheck, ctrl.committees.remove);
