...
const endpoints = [
  ...
  "/api/cms/about/hero",
  "/api/cms/about/values",
  "/api/cms/about/leadership",
  "/api/cms/esg/hero",
  ...
  "/api/cms/esg/collaboration-section",
  "/api/cms/esg/main-collaboration",
  "/api/cms/esg/developmental-orgs-section",
  "/api/cms/esg/developmental-orgs",
  "/api/cms/ash-utilization/hero",
  "/api/cms/ash-utilization/clients",
  "/api/cms/green-mobility/hero",
  "/api/cms/green-mobility/clients",
  "/api/cms/refrigerant-gas/hero",
  "/api/cms/refrigerant-gas/clients",
