/**
 * Migration script to download all PDFs from annual reports
 * and save them to the server's uploads/pdfs folder
 */
...
async function downloadPdf(url) {
  try {
    ...
    console.log(`  Saved to: /uploads/pdfs/${filename}`);
...
async function migrateAnnualReports() {
  console.log('='.repeat(60));
  console.log('Starting Annual Reports PDF Migration');
  console.log('='.repeat(60));
