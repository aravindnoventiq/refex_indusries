...
export default function RefrigerantGasWhyChooseUsSectionCMS() {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      await refrigerantGasCmsApi.deleteWhyChooseUs(id);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingFeature.id) {
        await refrigerantGasCmsApi.updateWhyChooseUs(editingFeature.id, editingFeature);
        setSuccess('Feature updated successfully');
      } else {
        await refrigerantGasCmsApi.createWhyChooseUs(editingFeature);
  ...
  const handleToggleActive = async (feature: WhyChooseUsFeature) => {
    try {
      await refrigerantGasCmsApi.updateWhyChooseUs(feature.id!, {
        ...feature,
