...
export default function StatementOfDeviationPage() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Statement of Deviation for Refex Industries Limited');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Statement of Deviation for Refex Industries Limited';
  ...
  const loadPageContent = async () => {
    try {
      ...
      console.error('Failed to load Statement of Deviation page:', err);
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">Loading Statement of Deviation information...</p>
              </div>
            </div>
          </div>
        </section>
