...
const EmployeeStockOptionSchemePage = () => {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Employee Stock Option Scheme (ESOP) information for Refex Industries Limited');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Employee Stock Option Scheme (ESOP) information for Refex Industries Limited';
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">Loading Employee Stock Option Scheme information...</p>
              </div>
            </div>
          </div>
        </section>
...
export default EmployeeStockOptionSchemePage;
