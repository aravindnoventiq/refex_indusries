...
const DisclosuresUnderSASTRegulations2011Page = () => {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Disclosures under SAST Regulations 2011 for Refex Industries Limited');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Disclosures under SAST Regulations 2011 for Refex Industries Limited';
  ...
  const loadPageContent = async () => {
    try {
      ...
      console.error('Failed to load Disclosures Under SAST Regulations 2011 page:', err);
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">Loading Disclosures Under SAST Regulations 2011 information...</p>
              </div>
            </div>
          </div>
        </section>
...
export default DisclosuresUnderSASTRegulations2011Page;
