...
const SecretarialComplianceReportPage = () => {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Secretarial Compliance Report for Refex Industries Limited');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Secretarial Compliance Report for Refex Industries Limited';
  ...
  const loadPageContent = async () => {
    try {
      ...
      console.error('Failed to load Secretarial Compliance Report page:', err);
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">Loading Secretarial Compliance Report information...</p>
              </div>
            </div>
          </div>
        </section>
