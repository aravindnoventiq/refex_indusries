...
export default function InvestorDynamicPage() {
  ...
  const getFilteredDocuments = (documents: Document[]): Document[] => {
    ...
    if (pageContent && pageContent.hasYearFilter) {
                ...
                pageContent.sections.map((section, sectionIndex) => {
                  ...
                  return (
                    <div key={sectionIndex} className="mb-8">
                      ...
                      {/* Content Items */}
                      {contents.length > 0 && (
                        <div className="overflow-hidden rounded-[1.35rem] border border-[#e3ebe0] bg-white shadow-[0_12px_40px_rgba(45,80,22,0.08)] p-8 mb-8">
