...
const StockExchangeQuarterlyCompliancePage = () => {
  ...
  const loadPageContent = async () => {
    try {
      ...
      console.error('Failed to load stock exchange quarterly compliance page:', err);
      // Use fallback data structure
      setPageContent({
        slug: 'stock-exchange-quarterly-compliance',
        title: 'Stock Exchange Quarterly Compliance',
        hasYearFilter: true,
        filterItems: ['2025-26', '2024-25'],
        sections: [],
        showPublishDate: false,
        isActive: true,
      });
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">Loading stock exchange quarterly compliance...</p>
              </div>
            </div>
          </div>
        </section>
...
export default StockExchangeQuarterlyCompliancePage;
