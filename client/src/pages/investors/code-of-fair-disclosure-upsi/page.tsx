...
export default function CodeOfFairDisclosureUPSIPage() {
  ...
  const loadPageContent = async () => {
    try {
      ...
      if (data && data.isActive) {
        // Standardize sections and documents
        let sections: any[] = [];
      ...
      console.error('Failed to load code of fair disclosure UPSI page:', err);
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">Loading code of fair disclosure UPSI...</p>
              </div>
            </div>
          </div>
        </section>
