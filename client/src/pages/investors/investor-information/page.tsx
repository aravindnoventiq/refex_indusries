...
// Fallback data - uses local server paths (run migration script if files missing)
// Data is fetched from API; this is only used when API is unavailable
const fallbackSections: Array<{ title: string; documents: Document[] }> = [];
...
const InvestorInformationPage = () => {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Investor Information - Refex Industries Ltd.');
    } else {
      const meta = document.createElement('meta');
      meta.name = 'description';
      meta.content = 'Investor Information - Refex Industries Ltd.';
          ...
          <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center py-12">
              <div className="text-center">
                ...
                <p className="mt-4 text-gray-600">Loading Investor Information...</p>
              </div>
            </div>
          </div>
        </section>
